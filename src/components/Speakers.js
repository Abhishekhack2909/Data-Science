      ...
      <div className="container-custom relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="font-display font-bold text-4xl md:text-6xl text-white mb-6" style={{textShadow: '2px 2px 8px rgba(0,0,0,0.8), 0 0 20px rgba(0,0,0,0.6)'}}>
            <span className="bg-black/60 px-4 py-2 rounded-2xl">Meet the</span>
            <span className="block bg-gradient-to-r from-accent-400 to-primary-400 bg-clip-text text-transparent mt-2" style={{textShadow: 'none'}}>Industry Leaders</span>
          </h2>
